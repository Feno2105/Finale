...
public class ServeurPrincipal {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            while (true) {
                ...
                System.out.println("Connexion avec le client en cours ...");
                new Thread(() -> {
                    try {
    ...
    private static void traiterClient(Socket clientSocket) throws Exception {
        ...
        System.out.println(commande);
            if (commande.startsWith("UPLOAD")) {
                ...
                System.out.println("Fichier reçu : " + fichierTemp.getAbsolutePath());
                ...
                System.out.println("Envoie de la list en cours...");
        ...
        try (Socket sousServeurSocket = new Socket(adresse, port);
             DataOutputStream dos = new DataOutputStream(sousServeurSocket.getOutputStream())) {
                if (signale == 1) {
                    ...
                    System.out.println("supprimer "+fichier.getName()+" dans le sous-serveur "+port);
                }
                if (signale == 0) {
    ...
    public static void envoilist(Socket client) throws Exception{
        ...
        try {
            ...
            obs.writeObject(f);
            obs.flush();
            System.out.println("Liste envoyer avec sucees");
        } catch (Exception e) {

...
public class Sousserver {
    ...
    public void demarrer() {
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            System.out.println("Sous-serveur démarré sur le port : " + port + " attribué au stockage "+dossierStockage);
            while (true) {
                try (Socket client = serverSocket.accept();
                    ...
                    System.out.println("Probleme de commande ou bien  fichier est introuvable");
                    System.out.println(e.getCause());
                    break;
                }
            }
        } catch (IOException e) {
          System.out.println("Probleme du serveur");
          System.out.println(e.getCause());
        }
    }
